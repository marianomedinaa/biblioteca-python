...
# Modernizar el sistema de gestión de una biblioteca
# utilizando Programación Orientada a Obejtos en
# Python. EL sistema debe permitir regristrar libros,
# usuarios, realizar préstamos y devoluciones, y
# consultar el estado de los libros

# --------------------------------------------
# SOLUCIÓN

# Solución estructurada con POO que facilite la
# gestión de la biblioteca al permitir un registro
# ordenado y actualizado de libros, usuarios y
# préstamos, mejorando la eficiencia y el control
# del negocio:

# -Registro de Libros
# -Registro de Usuarios
# -Registro de Préstamos
# -Versión interactiva para usarlo en consola
